#!/usr/bin/env python3
"""
GUI module for Dither Pie - Image and Video Dithering Tool
Contains the main GUI application class (DitheringApp).
"""
...
class DitheringApp(ctk.CTk):
    ...
    def _show_palette_dialog_and_apply(self):
        ...
        def create_custom_palette():
            from gui_components import CustomPaletteCreator
