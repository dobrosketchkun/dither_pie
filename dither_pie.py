# dithering_app.py
"""
A GUI + CLI app that uses dithering_lib for pixelization, color reduction, and dithering.
Run directly to get a GUI or CLI, or import in other scripts for the UI.
"""
    ...
    def do_pixel_dither(input_path,
        ...
        if is_video_file(input_path):
            ...
            try:
                ...
                for i, fpth in enumerate(frame_files, start=1):
                    try:
                        frm = Image.open(fpth)
                        if do_pixel:
